...
int nms(int batch_size,
    ...
    for (int batch = 0; batch < batch_size; batch++) {
        ...
        auto in_landms = static_cast<const float10 *>(inputs[2]) + batch * count;
        ...
        auto out_landms = static_cast<float10 *>(outputs[2]) + batch * detections_per_im;
        ...
        // Gather filtered scores, boxes, landms
        ...
        thrust::gather(on_stream, indices, indices + num_detections, in_landms, out_landms);
    }
    return 0;
}
